...
export const computeOverallEvaluation = (studentApp) => {
  ...
  return {
    ...
    ex1Rec,
    ex2Rec,
    advisorMark: !isNaN(advisorMark) ? advisorMark : (Number.isFinite(Number(apiAdvisorScore)) ? Number(apiAdvisorScore) : null),
    ex1Mark: !isNaN(ex1Mark) ? ex1Mark : (Number.isFinite(Number(apiEx1Score)) ? Number(apiEx1Score) : null),
    ex2Mark: !isNaN(ex2Mark) ? ex2Mark : (Number.isFinite(Number(apiEx2Score)) ? Number(apiEx2Score) : null),
    month1Rec: m1,
    month2Rec: m2,
